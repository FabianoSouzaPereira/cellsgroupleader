...
import br.com.cellsgroupleader.models.pessoas.User;
    ...
    public void loadSpinner(){
        ...
        queryListener =  new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter <String> adapter = new ArrayAdapter <>( AddLeaderActivity.this , R.layout.spinner_dropdown_item , cels );
